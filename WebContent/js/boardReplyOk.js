...
const boardReplyOkForm = document.querySelector("#boardReplyOkForm");
const boardReplyOkBtn = document.querySelector("#boardReplyOkBtn");
...
//	유효성 검사
boardReplyOkBtn.addEventListener('click',()=>{
